...
#define Board_LED_Set(led, state) {Chip_GPIO_SetPinState(LPC_GPIO, led, state);}
...
/**
 * Initialize the GPIO and the LED pins
 */
void Board_LEDs_Init(void);

/**
 * Initialize the UART peripheral with the desired baud rate
 * 
 * @param baudrate communication baud rate in Hz
 */
...
/**
 * Initialize the CAN peripheral and ROM API
 * 
 * @param baudrate communication baud rate in Hz
 * @param rx_callback function to call on can message receive
 * @param tx_callback function to call on can message transmit
 * @param error_callback function to call on can error
 */
